...
/************************************************************************
||
|| DATE:                $Date: 2006/04/03 19:35:54 $
|| SOURCE:              $Source: /repository/projects/Canpx/libutil/StorageManager.cpp,v $
|| STATE:               $State: Exp $
|| ID:                  $Id: StorageManager.cpp,v 1.3 2006/04/03 19:35:54 nickz Exp $
|| REVISION:    $Revision: 1.3 $
|| LOG:                 $Log: StorageManager.cpp,v $
|| LOG:                 Revision 1.3  2006/04/03 19:35:54  nickz
|| LOG:                 Fixed routine that opens directory
|| LOG:
...
StorageManager::getListLocation()
{
    ...
    {
	Logger::getLogger()->log(Logger::TYPE_ERROR,"StorageManager::getListLocation failed opening dir: %s [%s]",
				 _location, strerror(errno));
	return( ms );
    }
