/************************************************************************
||
|| DATE:                $Date: 2006/04/01 12:08:30 $
|| SOURCE:              $Source: /repository/projects/Canpx/libutil/DataGraph.hpp,v $
|| STATE:               $State: Exp $
|| ID:                  $Id: DataGraph.hpp,v 1.11 2006/04/01 12:08:30 nickz Exp $
|| REVISION:    $Revision: 1.11 $
|| LOG:                 $Log: DataGraph.hpp,v $
|| LOG:                 Revision 1.11  2006/04/01 12:08:30  nickz
...
class DataGraph : public Datum
{
	...
	public:
		...
		virtual ~DataGraph();
    		...
    		virtual datum_type type() { return( GRAPH ); }
