/************************************************************************
||
|| DATE:                $Date: 2006/05/02 14:38:54 $
|| SOURCE:              $Source: /repository/projects/Canpx/libutil/DataGraph.cpp,v $
|| STATE:               $State: Exp $
|| ID:                  $Id: DataGraph.cpp,v 1.10 2006/05/02 14:38:54 nickz Exp $
|| REVISION:    $Revision: 1.10 $
|| LOG:                 $Log: DataGraph.cpp,v $
|| LOG:                 Revision 1.10  2006/05/02 14:38:54  nickz
|| LOG:                 Committed Mikhail memory leak fix
|| LOG:
|| LOG:
...
DataGraph::delta(Subscriber *s)
{
	...
	for (it; it!= _dataImage.end(); it++){
		...
		if (itf != fm.fields.end()){
			...
			out.insert(DataMap::value_type((*itf).second, v));
