...
|| SOURCE:              $Source: /export/home/tomcat/mlsrc/libutil/RCS/Subscriber.hpp,v $
|| STATE:               $State: Exp $
...
class Subscriber
{
	...
	public:
		...
		virtual void setSubscribedFields(string &address, string& in, string& out);
		virtual void setHeaderFooter(string &address, string &header, string &footer);
		virtual void getMappedField(string &address, FieldMap &fm);
