...
|| SOURCE:              $Source: /export/home/tomcat/Build/canpx2/canpx2/RCS/CanpxHttpClient.cpp,v $
|| STATE:               $State: Exp $
|| ID:                  $Id: CanpxHttpClient.cpp,v 1.3 2006/04/26 18:27:20 mikhailt Exp $
|| REVISION:    $Revision: 1.3 $
|| LOG:                 $Log: CanpxHttpClient.cpp,v $
|| LOG:                 Revision 1.3  2006/04/26 18:27:20  mikhailt
...
CanpxHttpClient::onRecordRequestImpl(MsgGraph &image)
{
	...
	pubstr += "<form name=\"update\" action=\"recordUpdate\" method=\"POST\">";	string keyValTable;
...
CanpxHttpClient::onRecordUpdateImpl(MsgGraph &image)
{
	...
	if (image.getAttributeValue("data@HTTP", 0, datastr)){
		...
		if (data){
			...
			//string err = data->updateFromFlat(newdata);
